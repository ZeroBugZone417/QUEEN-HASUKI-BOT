...
cmd({
    ...
    try {
        await reply("🔍 Checking for XION-MD updates...");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your XION-MD bot is already up-to-date!");
        }

        await reply("🚀 Updating XION-MD Bot...");
        ...
        const sourcePath = path.join(extractPath, "SENU-MD-main");
